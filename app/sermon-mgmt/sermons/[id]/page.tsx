...
export default function AdminEditPage() {
  ...
  useEffect(() => {
    fetch(`/api/sermon-mgmt/sermons/${id}/data`)
      .then((r) => r.json())
      .then((data) => {
        setSermon(data);
        setTitle(data.title || "");
  ...
  async function handleSave() {
    ...
    const res = await fetch(`/api/sermon-mgmt/sermons/${id}`, {
      method: "PUT",
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="flex items-center gap-4 mb-8">
        <Link href="/sermon-mgmt" className="text-stone-400 hover:text-stone-600 text-sm">← All Sermons</Link>
