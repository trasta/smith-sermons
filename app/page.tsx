...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      <section className="bg-stone-900 text-white px-4 py-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-stone-300 text-sm">
            Listen in your favorite podcast app — Apple Podcasts, Spotify, and more.
          </p>
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block border border-stone-600 text-stone-300 text-xs font-semibold px-3 py-1.5 rounded-lg hover:bg-stone-800 transition-colors"
            >
              RSS Feed
            </a>
          </div>
